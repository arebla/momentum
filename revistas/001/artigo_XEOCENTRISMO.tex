...
\begin{figure*}[h]
    \centering
    \includegraphics[width=0.3\linewidth]{./revistas/001/imaxes/epiciclo.png}
    \hspace{1cm}
    \includegraphics[width=0.3\linewidth]{./revistas/001/imaxes/ecuante.png}
    \caption{
        Á esquerda, órbita con epiciclos, que Kepler chamaba ``pretzels''.
        Á dereita, modelo da ecuante de Ptolomeo. Imaxes de Wikipedia.
    }
    \label{fig:epiciclo}
\end{figure*}
