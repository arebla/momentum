\Titular*%
{pasatempos}%
{Sopa de letras, Triscelectrónico e Fortuna}%
{Autoría Múltiple}%
{Pasatempos para facer a comida na cafetería de física máis amena.}%

\Pasatempo{Sopa enerxética}{Adrián Vázquez Velasco}

Mediante o produto, cociente e composición das magnitudes e constantes da
seguinte sopa, podes obter \textbf{sete fórmulas para a enerxía} en distintos
contextos da física. Serás capaz de atopalas todas?

\vspace{2em}

{
\renewcommand{\arraystretch}{1.3} % orixinalmente 1.13
...
\Pasatempo{Triscelectrónico}{Adrián Vázquez Velasco}

\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{revistas/003/imaxes/triskel.jpg}
\end{figure}

Aplican as normas usuais dos sudokus. Ademais:
\begin{itemize}
    \item[1.] \textbf{Celas entrelazadas.} Cada un dos (tres) pares
        de celas separados por
        un círculo branco conteñen dous números consecutivos.
    \item[2A.] \textbf{Enchido de capas.} Os números dentro dunha
        caixa (indicada con
    ...
    \item[2B.] \textbf{Orbitais de electróns.} Hai tres tipos de
        celas: `s' (branco), `p'
        ...
        \begin{itemize}
            \item As celas `s' non aplican ningún modificador ás sumas
            \item Dentro de cada grupo de celas `p', unha engade $+1$ ao valor
                do díxito que conteña (de cara ás sumas de caixas), outra non
                afecta á suma, e outra réstalle un.
            \item Dentro de cada grupo de celas `d', é o mesmo pero de $-2$ a
                $+2$. Isto é, en cada grupo hai unha (e só unha) cela que
                engade cada valor de $\{-2,-1,\pm0,+1,+2\}$.
        \end{itemize}

    \item[3.] \textbf{Principio de exclusión local.} Ningunha cela
        pode estar contigua
...
\url{https://f-puzzles.com/?id=2a88em54}

Para aqueles que non estean moi familiarizados cos sudokus con caixas,
recomendo resolver este crebacabezas previamente:
\url{https://logic-masters.de/Raetselportal/Raetsel/zeigen.php?chlang=en&id=000809}.


\Pasatempo{Física ou Fortuna \#2: A ollo de bo cubeiro}{Adrián Vázquez Velasco}
...
A enquisa pecharase \textbf{tres semanas} trala publicación do número e a súa
ligazón poderá atoparse tanto ao lado do bote como no linktree dos pasatempos:
\url{https://linktr.ee/pasatempos.momentum}

\begin{figure}[H]
    \centering
    \includegraphics[width=0.5\linewidth]{revistas/003/imaxes/pasatempos_momentum.png}
\end{figure}
