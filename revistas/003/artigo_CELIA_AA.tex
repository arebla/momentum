\Titular*%
{reportaxes}%
{Kip Thorne visita Santiago}%
{Celia Álvarez Álvarez e Diego Couto García}%
{Santiago de Compostela acolle o Premio Nobel Kip S. Thorne durante a súa visita o pasado mes de maio.}

\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{revistas/003/imaxes/biblio_grupo.jpg}
    \caption*{
        Fotografía grupal de Kip Thorne con profesores e alumnos na biblioteca
        da Facultade de Física da Universidade de Santiago de Compostela.
...
Facultade de Medicina e Odontoloxía que tivo por nome <<\emph{Explorando o
lado curvado do noso universo: dende buracos negros e buracos de verme, ata
ondas gravitacionais e viaxes no tempo}>>.
...
\subsection*{Rolda de prensa no Pazo de Xelmírez}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{revistas/003/imaxes/rueda-prensa-conciencia-01.jpg}
    \caption*{
        Rolda de prensa no Pazo de Xelmírez. De esquerda a dereita: Jorge Mira,
        Kip Thorne e José Edelstein.
    }
\end{figure}
...
<<\emph{Cando miro cara a atrás vexo grandes cambios e grandes sorpresas, aínda
...
conteñen moita información sobre o nacemento do universo. <<\emph{Creo que
terán un gran papel no estudo do inicio do Universo}>>. Os físicos están a
...
\begin{figure}[H]
    \includegraphics[width=1\linewidth]{revistas/003/imaxes/clase.jpg}
    \caption*{Visita de Kip Thorne á clase de Gravitación o
    venres 9 de maio de 2025. Fotografía de Santi Alvite.}
\end{figure}

\begin{multicols}{2}

\subsection*{Visita á Facultade: clase de Gravitación e charla na biblioteca}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{revistas/003/imaxes/selfie.jpg}
    \caption*{Foto entre estudantes e o Nobel de física. Fotografía de Laura Quintáns.}
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=1\linewidth]{revistas/003/imaxes/libro_firmas.jpg}
    \caption*{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{revistas/003/imaxes/mom_sign.jpg}
    \caption*{
        Primeira e segunda edición da revista \emph{Momentum} asinadas por Kip
