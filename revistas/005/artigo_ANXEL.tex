...
estes esforzos foron parar a bo porto, máis ben o contrario, foron ocultos no
...
por iso e non porque as mates ás veces se nos fan costa arriba). Así que,
...
aprobar as materias do profesores? Esta historia non é máis que unha lección de
...
luz, 60 nanosegundos máis rápidos. Se isto fose medido por algún alumno da
...
que se debía tal anomalía. E é que os resultados presentáronnos como iso, unha
...
o porqué destes resultados, atopouse aos culpables: un cable de fibra óptica
...
\subsection*{A explosiva nova do Mars Climate Orber}
...
controladores decatáronse que había que realizar demasiadas correccións, máis
...
(comportamento máis propio dun político que de xente adicada á ciencia). Pero,
cal foi o accidente? Pois que a sonda foise apartando da orbita esperada a
...
Espero que estas tres pequenas historias fagan nos manter humildes, e nos facer
