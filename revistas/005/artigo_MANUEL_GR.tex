...
{Manuel Galán}%
{}
% {A historia de como o célebre físico visitou Galiza en 1934}
...
\begin{figure}[H]
    ...
    \caption{Erwin Schrödinger dando a conferencia o día 3 de agosto
    de 1933 no Paraninfo (Santiago de Compostela). (Fonte: GCiencia)}
    \label{charla}
\end{figure}

Casualmente, uns poucos días antes, tiña lugar o XIV Congreso da Asociación
Española para el Progreso de las Ciencias en Galiza\footnote{Concretamente, as
...
Máis tarde, trata sobre as nocións de espazo e tempo dunha partícula, onde
...
súa comunicación, moi avanzado para audiencia, poñendo como escusa a pouca
...
desenvolta desta vez na Coruña\footnote{Spoiler: ao final a Ortega y Gasset non
...
historiador Rafael Altamira ou do vizconde de Eza, presidente da asociación que
...
En definitiva, un desafortunado suceso que podería pasar calquera día na nosa
facultade, tal e como está construída.
...
achega a suficiente información. Posibelmente quedase en Santiago, pois dese
domingo data unha carta escrita en follas con \textit{Hotel Compostela} na
...
\begin{figure}[H]
    ...
    \caption{Imaxe do tráxico suceso no pazo de Oca (A Estrada)
    acontecido a 5 de agosto de 1933. (Fonte: GCiencia)}
    \label{accidente}
\end{figure}
