...
do aparello. O Big Ear adicábase a escanear o ceo, recibir sinais de radio, e
...
datos que revisaba Ehman refiríanse á intensidade de sinal recibida por
diversos canais, que se imprimía como un ratio sinal/fondo. Así, por exemplo,
se se rexistraba un sinal 4 veces máis forte que o ruído de fondo, imprimíase
un catro. Para aforrar espacio, os números do 10 en adiante representábanse con
letras: A para 10, B para 11, e sucesivamente. De súpeto, Ehman topouse coa
...
\begin{figure}[H]
    ...
    \caption{
        Páxina completa do printout no que Ehman observou o sinal
...
\eqref{im:perfil} podemos observar unha recreación da forma do sinal a partir
...
está prohibido empleala na Terra para transmisións de radio para non interferir
...
frecuencia como patrón natural do cosmos, e cando precisamos dunha unidade de
...
información? A resposta é que, se o facía, non chegou ata a nós. Para obter
...
alomenos con gran precisión. Resulta que o Big Ear estaba deseñado de tal xeito
...
de dúas posibilidades: ou a fonte transmitiu durante un periodo indeterminado
...
minutos entre escaneos (\cite{Lemmino}). Sexa como for, todo apunta a que o
...
planeta, que debería de emitir en contínuo (polo tanto, nun amplo largo de
...
podermos recrear o patrón medido. Tampouco é realista que o que se medise fose
un sinal emitido no chan que se reflictiu nalgún anaco de lixo espacial,
basicamente polas características dinámicas que tería que ter a órbita deste
espello para observar o sinal da figura \eqref{im:perfil}.
...
escintileo estelar é que permitiría a transformación dun sinal contínuo de
...
un chorro dun magnétar (un tipo de púlsar cun fortísimo campo magnético)
...
O certo é que, a un ano do 50 aniversario do sinal \textit{Wow!}, seguimos sen
