...
non ocupa no absoluto un rol central no seu artigo, é un mero exemplo dentro
...
queremos dicir cando afirmamos que o gato \textit{<<está vivo e morto á vez>>}.
...
anti-realismo, a noción de que un único átomo é intratable, e que se cadra
...
\begin{equation}
    \begin{split}
        \ket{\Psi} = \frac{1}{\sqrt{2}}( \ket{1, \text{veleno},
            \text{morto}} + \\
...
\begin{equation}
    \begin{split}
        \ket{\Psi, D} = \frac{1}{\sqrt{2}}( \ket{1, \text{veleno},
            \text{morto}, M} \\
