...
Todo os estudantes de física do universo coñecido escoitamos algunha vez falar
sobre o paradoxo do gato de Schrödinger e, malia isto, en ningún momento dos
nosos estudos démoslle nin tan sequera un mínimo tratamento. A percepción
xeral, quizais, é que este paradoxo é unha mera popularización da Mecánica
Cuántica ou, peor, que é un problema xa resolto, histórico, pero sen
relevancia actual. O certo é que a través deste \textit{gedankenexperiment}
Schrödinger pretendía sinalar os problemas conceptuais e de conexión co mundo
clásico que a mecánica cuántica (a chamada Interpretación de
Copenhague) presentaba e presenta. Así, nun artigo de $1935$
\cite{schrodinger1} no que discutía a situación da cuántica estándar e dos
seus problemas interpretativos, o austríaco escribía o seguinte:~\footnote{É
de interese resaltar que o paradoxo non ocupa no absoluto un rol central no
seu artigo, é un mero exemplo dentro dun capítulo onde discute a natureza
ontolóxica da función de ondas.}

\Cita{Un pode incluso establecer casos bastante ridículos. Un gato está
encerrado nunha cámara de aceiro, xunto ao seguinte diabólico dispositivo
(que debe estar protexido fronte a interferencia directa do gato): nun
...
durante una hora, diríase que o gato aínda vive se mentres tanto ningún átomo
decaeu. O primeiro decaemento atómico teríao envelenado. A función $\Psi$ do
sistema enteiro expresaría isto contendo ao gato vivo e ao gato morto
...
queremos dicir cando afirmamos que o gato \textit{<<está vivo e morto á
vez>>}.

\subsection*{Medindo o inmedible}

Como é que un átomo pode \textit{<<contaxiar>>} as súas propiedades cuánticas a
un ente macroscópico coma un gato? Como sabemos, a desintegración dun átomo
...
o anti-realismo, a noción de que un único átomo é intratable, e que se cadra
...
\begin{figure}[H] 
  ...
  \includegraphics[width=0.9\linewidth]{revistas/005/imaxes/schrodinger1.png}
...
\textit{<<catálogo de expectativas>>} \cite{schrodinger1}, todas as
...
\textit{<<interferencia entre posibilidades>>}, posto que senón a cuántica
...
xeito solaparse, e que este solapamento ven dado por unha fase relativa $\Phi$.
...
interfire consigo mesma tal e coma as ondas do mar, incluso nolo imaxinamos
...
\begin{figure}[H] 
  \centering
  %%%: Metese a figura como sempre. Pódese xogar co ancho pa axustala.
  \includegraphics[width=0.75\linewidth]{revistas/005/imaxes/dobre_fenda.png}
  \caption{Experimento da dobre fenda (Wikipedia).}
  \label{dobre_fenda}
\end{figure}

E é máis axeitada porque a interferencia non só se dá no espazo físico, nunha
pantalla que presenta un patrón de interferencia, como en óptica ondulatoria. A
interferencia dáse coas velocidades, co espín, co momento... En calquera base.
E no caso que nos ocupa, entre o estado de excitación dun átomo e a vitalidade
dun gato.

Así, ao principio, o estado do átomo será análogo o da moeda ($1=$ excitado,
$0=$ desexcitado)
...
Se o átomo se excita, entón o veleno libérase. Se pola contra nono fai, este
non se libera. Isto entrelaza ambas posibilidades, herdando a fase relativa do
átomo, de xeito que
...
Podería ser, por exemplo, unha cámara equipada cun software de intelixencia
...
\begin{figure}[H]   
  \centering
  %%%: Metese a figura como sempre. Pódese xogar co ancho pa axustala.
  \includegraphics[width=0.75\linewidth]{revistas/005/imaxes/schrodinger2.jpg}
...
Copenhague, resolvíase a golpe de postulado, o de colapso. Abordaremos este
...
\begin{figure}[H]   
  \centering
  %%%: Metese a figura como sempre. Pódese xogar co ancho pa axustala.
  \includegraphics[width=0.6\linewidth]{revistas/005/imaxes/interferometro.jpg}
...
base na que mide é precisamente a que combina estado excitado con desexcitado
~\footnote{O signo menos no segundo estado de medida é debido a que ambos deben
de ser ortogonais e á súa vez ser unha combinación de excitado e desexcitado.}
...
postulado do colapso: este levaba a considerar aos aparellos de medida como
...
o entrelazamento esténdese entre tódalas moléculas de aire, e é coma se
