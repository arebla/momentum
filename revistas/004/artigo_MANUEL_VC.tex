...
nin as investigacións de Thorne, Wheeler e Hawking, entre moitos outros.

% Con todo, como veremos a continuación, a historia sorpréndenos cun caso no que
% a curiosidade humana permite idear conceptos tan adiantados ao seu tempo, que
...
científicas: a revolución newtoniana do século XVII que preparou o terreo para as
posteriores revolucións da electrodinámica e da estrutura da materia no século
...
\subsection*{Argumento de Michell}
...
distribucións estelares

% \footnote{Sendo así o primeiro astrónomo estatístico.},
...
\Cita{
    ...
    information from \mbox{light}; yet, if any other luminous bodies should % este \mbox e para que non se separe li-ght
...
en\cite[pág. 92]{mongomeri}\footnote{Igualmente animo o lector a botarlle un
ollo ao artigo orixinal\cite{paper_largo_michell}, xa que ten certo interese
