...
\subsection*{Hipótese de Michell}
...
% está case todo aí.
% Michell non só predixo a existencia dos buracos negros, % FAI FALLA SACAR SO ESTO
...
en~\cite[pág. 92]{mongomeri}\footnote{Igualmente animo ó lector a botarlle un
...
\textit{``the same velocity a body would have if it fell from infinity to the
...
\Cita[Michell~\cite[Proposición 16, página 42]{paper_largo_michell}]{
