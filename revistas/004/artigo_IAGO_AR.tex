...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{revistas/004/imaxes/0a.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{revistas/004/imaxes/0b.png}
...
\begin{equation}
    T_M=687 \text{días} \Rightarrow \omega_M = \frac{360º}{687
    días}=0.524º/\text{días}
\end{equation}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{revistas/004/imaxes/1.png}
    \caption{Oposición Marte e ángulos do Sol e Tierra.}
\end{figure}

% \begin{figure}[H]
%     \centering
%     \includegraphics[width=\linewidth]{revistas/004/imaxes/2.png}
%     \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{revistas/004/imaxes/3.png}
...
senón que están inclinados cun ángulo $\alpha\thickapprox1.85º$. Isto permite
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{revistas/004/imaxes/4.png}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{revistas/004/imaxes/5.png}
    \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{revistas/004/imaxes/6.png}
    \caption{
