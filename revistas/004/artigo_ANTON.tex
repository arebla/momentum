...
\footnote{Boa parte das teses de \textit{Naming and Necessity} xa foran
...
que o mundo é), mentres que \textit{a priori} e \textit{a posteriori} son categorías
...
verdadeiro, podería non selo. Un enunciado é \textit{a priori} cando pode
coñecerse independentemente da experiencia e \textit{a posteriori} cando
soamente pode coñecerse por medio da experiencia \footnote{Os exemplos típicos
de enunciados que poden coñecerse \textit{a priori} son os das matemáticas: $2+1=3$. Non
fai falta máis nada que coñecer regras e funcións para saber realizar unha
suma; non fai falta ir ao mundo.}. Para Kripke, ningunha destas dúas categorías
(necesidade e aprioricidade) están contida unha na outra \footnote{Neste punto
é probable (se liches o pé da páxina número 2) que os enunciados a priori sexan
...
modo que non todo o que é necesario é \textit{a priori}, nin todo o que é
\textit{a priori} é necesario \footnote{A tradición (os positivistas lóxicos)
consideraba que si.}. Kripke entende que os enunciados analíticos son
verdadeiros en virtude do seu significado e que son verdadeiros en todos os
mundos posibles en virtude do seu significado.
...
contrafácticas \footnote{A caracterización lóxica é: $\neg P \implies Q $.}, é
...
\begin{enumerate}
    \item[(1)] «un metro é a lonxitude de $B$, onde $B$ é certa barra que hai
        en París».
\end{enumerate}
...
Se respondemos \textit{a}, estariamos dicindo que a barra mide necesariamente
un metro de longo o que implicaría dicir que (1) é unha verdade necesaria, e
por tanto, \textit{a priori}. Malia isto, se sometemos a unha certa temperatura
...
Se respondemos \textit{b} estariamos a dicir: hai unha determinada lonxitude
...
$B$ en $t_0$ someteuse á calor, a barra $B$ en $t_0$ non tería un metro de
...
\begin{enumerate}
   \item Dicir que «$B$ ten un metro de longo» é un enunciado continxente
       \footnote{Enunciado que pode ser doutro modo noutro mundo posible. Sempre e
       cando «un metro» sexa un designador ríxido.}.
   \item  Ao dicir que «$B$ ten un metro de longo» parece que se sabe 
       \textit{a priori} que a barra B ten un metro de longo.
\end{enumerate}

\subsection*{Conclusións}

O caso do metro móstranos unha idea moi suxestiva: algo pode ser continxente e
pode coñecerse \textit{a priori}. É continxente porque podería empregarse outra
barra ou variar as dimensións desta, para estipular que é un metro. Agora ben,
é \textit{a priori} porque unha vez estipulado, isto é, unha vez establecida a
...
baleiro en $1/299\, 792\, 458$ partes dun segundo e non se empregue unha barra de
platino para fixar a lonxitude dun metro, o termo «a distancia percorrida pola
luz no baleiro en $1/299\, 792\, 458$ partes dun segundo» continúa a funcionar como
un designador ríxido xa que segue fixando a referencia dun metro, aínda que
sexa mediante un feito físico diferente. Podemos imaxinar un mundo posible onde
a luz tardase máis ou menos en percorrer esa distancia, e aínda así chamariamos
«un metro» a esa lonxitude.
