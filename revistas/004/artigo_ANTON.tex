...
ríxido»\footnote{Boa parte das teses de \textit{Naming and Necessity} xa foran
...
que o mundo é), mentres que \textit{a priori} e \textit{a posteriori} son
...
de enunciados que poden coñecerse \textit{a priori} son os das matemáticas:
...
dúas categorías (necesidade e aprioricidade) están contida unha na
outra\footnote{Neste punto é probable (se liches o pé de páxina número 3) que
...
é \textit{a priori}, nin todo o que é \textit{a priori} é necesario\footnote{A
...
\noindent Desta oración podemos extraer dúas interpretacións:
...
\begin{enumerate}
   \item Dicir que «$B$ ten un metro de longo» é un enunciado
...
baleiro en $1/299\, 792\, 458$ partes dun segundo e non se empregue unha barra
de platino para fixar a lonxitude dun metro, o termo «a distancia percorrida
pola luz no baleiro en $1/299\, 792\, 458$ partes dun segundo» continúa a
