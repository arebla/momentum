...
\begin{figure}[H]
    ...
    \caption{
        O parsec, a unidade de distancia máis empregada en
        astronomía.\cite{Wikimedia}
    }
\end{figure}
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{revistas/004/imaxes/supernova.jpg}
    \caption{
        SN 2025rbs, unha supernova de tipo Ia descuberta en xullo deste ano na
