...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{revistas/004/imaxes/mary1.png}
    \caption{
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{revistas/004/imaxes/mary2.png}
...
%
\begin{align*}
    m\ddot{u}_j =\ &k(u_{j+1} + u_{j-1}-2u_j )\\
...
%
\begin{align*}
    H = \frac{1}{2}\sum_{i=0}^N \left(\frac{p_i^2}{m} +
...
%
\begin{align*}
    H =\ &\frac{1}{2}\sum_{j=1}^N \left(\frac{{p'}_j^2}{m} +m\omega_j^2q_j^2\right) \\
    &+\frac{\alpha}{3}\sum_{j,l,m=1}^N c_{jlm}a_ja_la_m\omega_j\omega_l\omega_m.
\end{align*}
%
...
%
\begin{align*}
    S_n &= \sum_j^N(-i)^nF\left[\sum_k A\left(e^{i\frac{(j+i)k\pi}{N+1}}-e^{i\frac{jk\pi}{N+1}}\right)\right]^n\\
    S_n &= F\sum_j^N\left[a_k\exp\left(i\frac{(j+i/2)k\pi}{N+1}\right)2\sin\left(\frac{k\pi}{2(N+1)}\right)\right]^n\\
    S_n &= F\sum_j^N\left[a_k\frac{\omega_k}{\omega_0}\exp\left(i\frac{(j+i/2)k\pi}{N+1}\right)\right]^n.
\end{align*}
%
...
%
\begin{align*}
    c_{jlm} &= 2k\frac{(N+1)F}{\omega_0^3}Z(x)D(x) \\
            &=\frac{k}{\omega_0^3\sqrt{2(N+1)}}Z(x)D(x).
\end{align*}
%
...
\begin{figure}[H]
    \centering
    \includegraphics[width=\linewidth]{revistas/004/imaxes/mary3.png}
    \caption{
