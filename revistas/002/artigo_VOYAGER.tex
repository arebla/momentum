...
\Cita[Carl Sagan, \textit{Cosmos} (adaptación)]{%
...
galileanos: Ío, Europa, Ganímedes e Calisto, da Gran Mancha Vermella de Xúpiter
...
1 tivo a súa engalaxe a bordo do vehículo de lanzamento \textit{Titan IIE} tras
...
primeira foto do noso fogar e o seu único satélite.
...
Oitenta días antes do encontro con Xúpiter comezaron as observacións do
...
masa de Xúpiter para logo sobrevoar Ío, Europa, Ganímedes e Calisto.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\linewidth]{revistas/002/imaxes/jupiter.jpg}
    \caption{Xúpiter cos satélites Ío (esquerda) e Europa.}
    \label{fig:voya1}
\end{figure}

Descóbrese o sistema xoviano de aneis e dúas lúas, Thebe e Metis, desvélase que
a Gran Mancha Vermella se trata dunha grandísima tormenta que recorda a un
ciclón e avístanse e detéctanse os primeiros volcáns activos e o primeiro
lóstrego máis aló da Terra. A Voyager 1 comeza a súa viaxe cara a Saturno
deixando ao redor de 180.000 fotografías do sistema xoviano, incluíndo
películas a cor das dinámicas das nubes xovianas.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{revistas/002/imaxes/io.jpg}
    \caption{Explosión do volcán Loki en Ío.}
    \label{fig:voya2}
\end{figure}

O 9 de novembro de 1980 sucede o encontro coa lúa máis grande de Saturno,
Titán, e co propio Saturno. Descóbrense Atlas, Prometeo e Pandora, tres
``pequenas'' lúas das máis de duascentas que actualmente se coñecen orbitando
este xigante gasoso. As órbitas de Prometeo e Pandora ao redor dos aneis F de
Saturno confirman a teoría da existencia de ``satélites pastores'' que producen
...
Saturno que se pasarían a denominar raios, cuxa orixe non se comprende
completamente na actualidade.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.8\linewidth]{revistas/002/imaxes/saturno.jpg}
    \caption{Saturno con Tetis (arriba-dereita) e Dione. As
...
vida, quizais a escala microscópica. A misión \textit{Dragonfly} enviará unha
aeronave rotatoria robótica, será lanzada en xullo de 2028 e chegará a Titán en
2034.

\begin{figure}[H]
    \centering
    \includegraphics[width=0.6\linewidth]{revistas/002/imaxes/Dust_storm_on_Titan_pillars_corte.jpg}
    \caption{Concepción artística dunha tormenta de po en Titán con Saturno de fondo.}
    \label{fig:voya4}
\end{figure}
...
impulso gravitacional, a sonda comeza a afastarse do plano da eclíptica do
...
\begin{figure}[H]
    ...
    \caption{\textit{Pale Blue Dot}: imaxe da Terra tomada
...
convértese no obxecto feito polos humanos máis afastado da Terra, a unha
...
Entre 2021 e 2024 a Voyager enfrontou varios desafíos relacionados coa
corrupción de datos e a súa transmisión á Terra, probablemente pola degradación
dos seu aparellos tras décadas de exposición á radiación espacial. Deste ano a
unha década, espérase que a Voyager xa non dispoña de enerxía para alimentar
ningún dos instrumentos a bordo e perderemos o seu sinal para sempre.\\
...
estrela máis próxima ao sistema solar. A sonda tardará uns trinta mil anos en
...
\Cita[Carl Sagan, \textit{Pale Blue Dot} (adaptación)]
{
