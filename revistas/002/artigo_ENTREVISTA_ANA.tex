...
\paragraph{A:} O noso grupo intégrase no que se coñece como DPAC (\textit{Data
...
\begin{figure}[H]
    ...
    \caption{Foto da Vía Láctea polo proxecto Gaia. Fonte: ESA/Gaia/DPAC, por Stefan Payne-Wardenaar}
    \label{fig:ana2}
\end{figure}
...
\paragraph{G:} Unha cuestión que se formula máis dalgunha estudante é se a
...
\begin{figure}[H]
    ...
    \caption{Participantes da 2ª Reunión do Consorcio DPAC en Sitges, España. Fonte: ESA/Gaia/DPAC}
    \label{fig:ana3}
...
exemplo: un \textit{software} para recoñecer galaxias afastadas é útil para detectar
...
ben, espérase que todo o mundo coñeza \textit{El Quijote} ou \textit{La Gioconda} pero que o
