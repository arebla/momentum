...
clásica.
    ...
    \begin{figure}[H]
       ...
       \caption{Traxectorias posibles para unha partícula. \cite{bahramhouchmandzadeh_2020}}
       \label{fig:schro1}
    \end{figure}
...
\begin{figure}[H]
   ...
   \caption{Relación entre as superficies de fase constante e os raios. \cite{bahramhouchmandzadeh_2020}}
   \label{fig:schro2}
\end{figure}
...
\begin{figure}[H]
   ...
   \caption{Ondas localmente planas. \cite{apuntes_optica_2}}
   \label{fig:schro3}
\end{figure}
