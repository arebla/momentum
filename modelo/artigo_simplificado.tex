...
%%%: o esquema da bibliografía             momentum-citacions.csl
...
%%%: debería bastar con premer calquera botón de 'executar'. Se non funciona
...
%%%: á súa vez, elixir que compiladores/executables se usan de xeito automático,
...
%%%:
%%%: Primeiro, cargamos a información bibliográfica
